        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $pending_comment_counts = mysqli_num_rows($pending_comments);

                    $query = "SELECT * FROM users WHERE user_role = 'subscriber'";
                    $select_all_subscribers = mysqli_query($connection, $query);
                    $subcribers_counts = mysqli_num_rows($select_all_subscribers);
                ?>
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        ['Data', 'Count'],
                            <?php
                                $element_text = ['All Posts', 'Active Posts', 'Draft Posts', 'Comments', 'Pending Comment', 'Users', 'Subscribers', 'Categories'];
                                $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $pending_comment_counts, $user_counts, $subcribers_counts, $category_counts];
